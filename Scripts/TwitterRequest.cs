...
namespace TwitterForUnity
{
    ...
    public class Client
    {
        ...
        public IEnumerator Get(string APIPath, Dictionary<string, string> APIParams, TwitterCallback callback)
        {
        ...
        public IEnumerator Post(string APIPath, Dictionary<string, string> APIParams, TwitterCallback callback)
        {
            string REQUEST_URL = "https://api.twitter.com/1.1/" + APIPath + ".json";
            SortedDictionary<string, string> parameters = Helper.ConvertToSortedDictionary(APIParams);
        ...
        private void SetAPIParams(SortedDictionary<string, string> parameters, Dictionary<string, string> APIParams)
        {
        ...
        private string GenerateRequestparams(SortedDictionary<string, string> parameters)
        {
        ...
        private IEnumerator SendRequest(UnityWebRequest request, SortedDictionary<string, string> parameters, string method, string requestURL, TwitterCallback callback)
        {
